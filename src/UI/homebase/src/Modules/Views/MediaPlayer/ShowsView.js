...
class ShowsView extends Component {
  ...
  getShows(page, order, searchTerm, include_previous_pages){
    ...
    axios.get(window.vars.apiBase + 'shows?page='+page+'&orderby='+encodeURIComponent(order)+'&keywords='+encodeURIComponent(searchTerm)+ "&include_previous="+include_previous_pages).then(data => {
