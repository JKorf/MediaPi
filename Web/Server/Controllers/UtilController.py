...
class UtilController:
    ...
    @staticmethod
    def version():
        return to_JSON(Version("30/08/2017", "1.6.1"))
    ...
    def get_settings():
        set = Settings(AppSettings.get_bool("raspberry"),
                       ...
                       AppSettings.get_bool("yify_subtitles"),
                       AppSettings.get_int("max_subtitles_files"))
        return to_JSON(set)

    @staticmethod
    def save_settings(raspberry, gui, external_trackers, yts_movie_api, os_subs, yify_subs, max_subs):
        ...
        AppSettings.set_setting("yts_movie_api", parse_bool(yts_movie_api))
